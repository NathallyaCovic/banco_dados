...
<head>
    ...
    <title>Gerenciar notas - Gestão de notas dos alunos</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <div class="container">
            <a class="navbar-brand" href="teacher.php">
                <i class="fas fa-edit"></i> Gerenciamento de notas
            </a>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-plus-circle"></i> Adicionar uma Nova Nota</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="classroom_id" required>
                                            <option value="">Selecionar Sala de Aula...</option>
                            ...
                            <button type="submit" name="add_grade" class="btn btn-primary">
                                <i class="fas fa-save"></i> Adicionar Nota
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-chart-bar"></i> Estatísticas de Notas</h4>
                    </div>
                    <div class="card-body">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <table class="table table-sm">
                            <tr><td>90-100</td><td><span class="badge bg-success">A</span></td><td>Excelente</td></tr>
                            <tr><td>80-89</td><td><span class="badge bg-info">B</span></td><td>Bom</td></tr>
                            <tr><td>70-79</td><td><span class="badge bg-warning">C</span></td><td>Satisfatório</td></tr>
                            <tr><td>60-69</td><td><span class="badge bg-danger">D</span></td><td>Precisa de melhorias</td></tr>
                            <tr><td>Abaixo de 60</td><td><span class="badge bg-dark">F</span></td><td>Reprovado</td></tr>
                        </table>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-list"></i> Notas Recentes</h4>
                    </div>
                    <div class="card-body">
