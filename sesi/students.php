...
<head>
    ...
    <title>Portal do Aluno - Gestão de Notas do Aluno</title>
                    ...
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#grades" data-bs-toggle="tab">
                                <i class="fas fa-chart-bar me-2"></i>Minhas Notas
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#performance" data-bs-toggle="tab">
                                <i class="fas fa-trending-up me-2"></i>Desempenho
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-md-9 col-lg-10 ms-sm-auto px-4 py-4">
                <div class="tab-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between mb-1">
                                                <span>Nota <?php echo $letter; ?></span>
                    ...
                    <div class="tab-pane fade" id="performance">
                        <h2 class="mb-4">Análise de Desempenho</h2>
                        
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Tendência de Notas por Assunto</h5>
                                    </div>
                                    <div class="card-body">
