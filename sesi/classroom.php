...
<head>
    ...
    <title>Gerenciamento de Salas de Aula - Gestão de Notas dos Alunos</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container">
            <a class="navbar-brand" href="teacher.php">
                <i class="fas fa-chalkboard-teacher"></i> Portal do Professor
            </a>
            <div class="navbar-nav ms-auto">
                <span class="navbar-text me-3">
                    Welcome, <?php echo $_SESSION['first_name']; ?>
                </span>
                <a class="nav-link" href="teacher.php">Painel</a>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>
                        ...
                        Estudantes em <?php echo $teacher_classrooms[array_search($_GET['classroom_id'], array_column($teacher_classrooms, 'id'))]['name']; ?>
                    </h4>
                    <a href="classroom.php" class="btn btn-secondary">Voltar para as Salas de Aulas</a>
                </div>
                <div class="card-body">
        ...
        <?php else: ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h4><i class="fas fa-plus-circle"></i> Criar uma Nova Sala de Aula</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST">
                                <div class="mb-3">
                                    <label class="form-label">Nome da Sala de Aula</label>
                                ...
                                <button type="submit" name="create_classroom" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Criar Sala de Aula
                                </button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h4><i class="fas fa-user-plus"></i> Adicionar Alunos para a Sala de Aula</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST">
                                <div class="mb-3">
                                    <label class="form-label">Selecionar Sala de Aula</label>
                                    <select class="form-select" name="classroom_id" required>
                                        <option value="">Escolher Sala de Aula...</option>
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Selecionar um Aluno</label>
                                    <select class="form-select" name="student_id" required>
                                        <option value="">Escolher um Aluno...</option>
                                ...
                                <button type="submit" name="add_student" class="btn btn-success">
                                    <i class="fas fa-user-plus"></i> Adicionar Estudantes
                                </button>
                            </form>
                        </div>
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4><i class="fas fa-chalkboard"></i> Minhas Salas de Aula</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-primary"><?php echo $count; ?> Estudantes</span></td>
                                            <td>
